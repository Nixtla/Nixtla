...
index = {"uids_ts_from_df": "dataloaders.ipynb",
         ...
         "TimeSeriesDataset.get_meta_data_var": "dataset_class.ipynb",
         "TimeSeriesDataset.get_static_data": "dataset_class.ipynb",
         "TimeSeriesDataset.get_filtered_tensor": "dataset_class.ipynb",
         ...
         "mse": "esrnn_utils_evaluation.ipynb",
         "mape": "esrnn_utils_evaluation.ipynb",
         "smape": "esrnn_utils_evaluation.ipynb",
