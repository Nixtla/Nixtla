# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/experiments_nbeats_sota_params_m3.ipynb (unless otherwise specified).

__all__ = ['common_grid', 'common_ensemble_grid', 'Yearly', 'Quarterly', 'Monthly', 'Other', 'TourismParams']
...
# Cell
TourismParams = Info(groups=('Yearly', 'Quarterly', 'Monthly', 'Other'),
