# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/experiments_nbeats_sota_params_m4.ipynb (unless otherwise specified).
...
# Cell
M3Params = Info(groups=('Yearly', 'Quarterly', 'Monthly', 'Weekly', 'Daily', 'Hourly'),
