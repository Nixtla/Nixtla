# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/models_nbeats__onnbeats.ipynb (unless otherwise specified).

__all__ = ['init_weights', 'Nbeats', 'Nbeats']
...
class Nbeats(object):
    ...
    def fit(self, train_ts_loader, val_ts_loader=None, n_iterations=None, verbose=True, eval_steps=1):
        ...
        self.f_idxs = train_ts_loader.ts_dataset.get_x_f_idxs(self.f_cols)
